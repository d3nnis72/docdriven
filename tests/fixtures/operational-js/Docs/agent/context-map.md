...
|---|---|---|---|---|---|---|---|
| architecture-general | Architecture change | `knowledge/architecture/README.md` | `knowledge/architecture/README.md` | src/** | architecture docs, human architecture if user-facing | test | unknown |
